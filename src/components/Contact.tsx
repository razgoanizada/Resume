    ...
    <section>
      <MDBContainer className="text-center mt-3">
        <MDBRow className="mt-3">
          <MDBCol sm="6" md="4" lg="3" xl="3" className="mx-auto items-center mb-md-0 mb-4 contact">
            <div className="text-start mt-4">
            <p>
              <MDBIcon color="secondary" icon="home" className="me-2 black" />
             <b> Kfar Saba, Israel</b>
            </p>
            <p>
